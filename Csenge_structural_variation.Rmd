...
Step 5: Calculate HW equilibrium

WIP, couldn't install the R package outside of the R in ondemand...

OUT: AA, Aa or aa for each individual and PCA plot, with map

# 4. Fst between homozygotes
