...
-   Local PCA MDS plot with chromosome plot + PCAs for the 3 corners for
    bp [] and snp sizes [500,1000,5000,10_000]
-   mds_coords.csv, mychromosome.regions.csv, pca_corners
...
Changes: - do.pdfs \<- TRUE in line 14, - commented out warning in line
78, breaks code otherwise - added saving of corner pcas - added getting
the percent corner (i.e. alpha) as a variable read from a file
...
INPUT: MDS output files for a specific chromosome, specific lostruct
run/visualisation OUTPUT: Outlier region genomic coordinates

# 4. Grouping individuals by genotype for specific region

INPUT: Coordinates of region of interest, bcf file of chromosome OUT:
AA, Aa or aa for each individual and PCA plot

# 4. Further analysis of region

INPUT: Genomic coordinates of interest, genotype category for each
individual OUTPUT: Fst, LD, nuc diversity, GO
