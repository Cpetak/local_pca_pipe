...
It is chromosome, type, size, alpha (percent outliers considered).
...
INPUT: MDS output files for a specific chromosome, specific lostruct run/visualisation
...
OUT: AA, Aa or aa for each individual and PCA plot

# 4. Further analysis of region
INPUT: Genomic coordinates of interest, genotype category for each individual
OUTPUT: Fst, LD, nuc diversity, GO
