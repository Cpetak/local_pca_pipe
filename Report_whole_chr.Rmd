...
```{r, echo=FALSE,}
library(gtools)
all_files <- list.files('~/WGS/local_pca_pipe/lostruct_results_noouts/')
...
for (file in all_files) {
  if (grepl(params$chr, file)) {
    ...
    curr_file<-paste0('~/WGS/local_pca_pipe/lostruct_results_noouts/', file, "/figure/run_summary/plot_corners-1.png")
    my_plots1<-append(my_plots1,curr_file)
    curr_file<-paste0('~/WGS/local_pca_pipe/lostruct_results_noouts/', file, "/figure/run_summary/plot_corner_pca-1_1_2.pdf")
